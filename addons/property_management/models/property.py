...
class UtilityUtility(models.Model):
    _name = "utility"
...
class PropertyInsurance(models.Model):
    ...
    def check_start_date(self):
        ...
        for property_insurance in self:
            if property_insurance.start_date and property_insurance.end_date:
                if property_insurance.start_date > property_insurance.end_date:
                    raise ValidationError("In Insurance Start date must be "
                                        "less than end date.")
